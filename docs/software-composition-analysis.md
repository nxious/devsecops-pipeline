...
All of the reports generated by various tools were stored in `JSON` format under the `reports` folder located in the default home directory of the jenkins user (/var/lib/jenkins).